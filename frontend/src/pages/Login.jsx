  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-black">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://www.bombayshavingcompany.com/cdn/shop/files/3_53.webp?v=1744351588')",
        }}
      >
        ...
        <div className="relative z-10 max-w-xl px-10 text-white">
          ...
          <p className="text-lg text-gray-300 mt-6 leading-relaxed">
            Discover premium perfumes crafted for elegance,
      ...
      <div className="flex items-center justify-center px-6 py-12 bg-[#f8f5ef]">
        ...
        >
          ...
          <p className="text-center text-gray-500 mt-4">
            Access your luxury fragrance account.
          </p>
          ...
          <div className="text-right mt-4">
            <Link
              to="/forgot-password"
              className="text-sm font-bold text-[#c9a24d]"
            >
              Forgot Password?
            </Link>
          </div>
